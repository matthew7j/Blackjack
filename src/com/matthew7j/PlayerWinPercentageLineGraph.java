...
public class PlayerWinPercentageLineGraph extends ApplicationFrame
{
    private ArrayList<Person> players = new ArrayList<Person>();
    private int handNum;
    private CategoryDataset dataset;

    public PlayerWinPercentageLineGraph(final String title, ArrayList<Person> players, int handNum){
        super(title);
    ...
    private CategoryDataset createDataset(){
        ...
        for (Person p : players){
            if (p instanceof Player) {
                double num = ((Player) p).getPercentageHandsWon();
    ...
    public void addData(ArrayList<Person> players, int handNum){
        ...
        for (Person p : players){
            if (p instanceof Player) {
                datasetTemp.addValue((Number) ((Player) p).getPercentageHandsWon(), p.name, handNum);
            }
        }
